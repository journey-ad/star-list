# journey-ad's Stars [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
...
* [chenqinggang001/claude-code-build](https://github.com/chenqinggang001/claude-code-build) - Can run modifiable claude code source code
...
* [huangkaoya/ts-redalert2](https://github.com/huangkaoya/ts-redalert2) - 红色警戒2源代码 Red Alert2 Source Code
...
* [LB623/no-negative-echo](https://github.com/LB623/no-negative-echo) - 让 Codex 根据最终结果生成标题、注释、commit 和 PR，减少被否决方案在交付中的残留。
...
* [Th3w33knd/reVCDOS](https://github.com/Th3w33knd/reVCDOS) - Web-based port running in browser via WebAssembly.
...
* [Lolendor/reVCDOS](https://github.com/Lolendor/reVCDOS) - Web-based port of GTA: Vice City running in browser via WebAssembly.
...
* [avwo/whistle-client](https://github.com/avwo/whistle-client) - HTTP, HTTP2, HTTPS, Websocket debugging proxy client

* [davidje13/lean-qr](https://github.com/davidje13/lean-qr) - Minimal library for generating QR codes in the browser and server-side.
...
* [S-Trespassing/claw-in-chrome](https://github.com/S-Trespassing/claw-in-chrome) - 这是一个放在 Chrome 侧边栏里的助手扩展。解除了Claude in Chrome的登录限制和套餐限制,支持自定义模型供应商,并且支持编辑原插件不支持编辑的参数,让您的大模型在该插件中有更好的表现!
...
* [Aaalice233/ComfyUI-Danbooru-Gallery](https://github.com/Aaalice233/ComfyUI-Danbooru-Gallery) - D站画廊插件
...
* [ethan-well/react-blog](https://github.com/ethan-well/react-blog) - React + Redux + Ruby On Rails 实现的博客系统
...
* [chokcoco/img2pureDiv](https://github.com/chokcoco/img2pureDiv) - 任意图片转换为单 div 实现
...
* [Jackliu007888/peppa-editor](https://github.com/Jackliu007888/peppa-editor) - online：
...
* [kkkisme/download-xiaoce](https://github.com/kkkisme/download-xiaoce) - 下载掘金小册保存为markdown和pdf
...
* [Tilerphy/ps4broadcast](https://github.com/Tilerphy/ps4broadcast) -
...
* [4074/DrawingPlace](https://github.com/4074/DrawingPlace) - A website for pixel drawing
...
* [mohan43u/gistnotes](https://github.com/mohan43u/gistnotes) - notes app which directly store data in github

* [lagartoflojo/gnomehub](https://github.com/lagartoflojo/gnomehub) - A Gnome 3 Shell extension that shows your favorite GitHub repos and their open pull requests on the top panel
...
* [ertdfgcvb/Sequencer](https://github.com/ertdfgcvb/Sequencer) - A fast(?) fullscreen image-sequence player
...
* [PearInc/PearPlayer.js](https://github.com/PearInc/PearPlayer.js) - 支持WebRTC的多源多协议混合P2P-CDN的流媒体播放器

* [zenozeng/font-detect.js](https://github.com/zenozeng/font-detect.js) - Detect font without flash, simply using javascript & @font-face
...
* [kenischu/ReSource](https://github.com/kenischu/ReSource) -
...
* [YuriSizov/godot-editor-theme-explorer](https://github.com/YuriSizov/godot-editor-theme-explorer) - (mirror) A utility for exploring current editor GUI theme and its components (fonts, styles, icons, etc).
...
* [m5stack/M5Cardputer-UserDemo](https://github.com/m5stack/M5Cardputer-UserDemo) - M5Cardputer user demo for hardware evaluation.
...
* [mmozeiko/pkg2zip](https://github.com/mmozeiko/pkg2zip) - Decrypts PlayStation Vita pkg file and packages to zip archive

* [yifanlu/psvimgtools](https://github.com/yifanlu/psvimgtools) - Decrypt Vita CMA backups

* [TheOfficialFloW/h-encore](https://github.com/TheOfficialFloW/h-encore) - Fully chained kernel exploit for the PS Vita on firmwares 3.65-3.68
...
* [qi-hua/async\_cosyvoice](https://github.com/qi-hua/async_cosyvoice) - 使用vllm加速cosyvoice2的推理
...
* [juni-vogt/wttr-uebersicht](https://github.com/juni-vogt/wttr-uebersicht) - wttr.in Übersicht widget
...
* [spiritree/typecho-theme-amaze](https://github.com/spiritree/typecho-theme-amaze) - :mount\_fuji: Typecho theme based on AmazeUI
...
* [satoshiiizuka/siggraph2016\_colorization](https://github.com/satoshiiizuka/siggraph2016_colorization) - Code for the paper 'Let there be Color!: Joint End-to-end Learning of Global and Local Image Priors for Automatic Image Colorization with Simultaneous Classification'.
...
* [maicong/stay](https://github.com/maicong/stay) - A responsive theme for Typecho. 一款响应式 Typecho 主题
...
* [noisan/parsedown-rubytext](https://github.com/noisan/parsedown-rubytext) - An extension of Parsedown that adds support for ruby text (aka furigana) in Markdown. Markdownでルビの指定が可能になるParsedown用エクステンション
...
* [MortyFx/typecho-theme-apollo](https://github.com/MortyFx/typecho-theme-apollo) - A minimalism typecho theme.
...
* [hoohack/zhihuSpider](https://github.com/hoohack/zhihuSpider) - A zhihu Spider.Just for fun.
...
* [BlackGlory/Gloria](https://github.com/BlackGlory/Gloria) - ⚰️ A programmable notifier.
